...
unset($__errorArgs, $__bag); ?>
								<input type="text" name="name" value="<?php echo e(old('name')); ?>" placeholder="First Name">
...
unset($__errorArgs, $__bag); ?>
								<input type="text"  name="mobileno" value="<?php echo e(old('mobileno')); ?>" placeholder="Mobile">
...
unset($__errorArgs, $__bag); ?>
								<input type="text" placeholder="Gender" value="<?php echo e(old('gender')); ?>" name="gender">
...
</html><?php /**PATH C:\xampp\htdocs\laravel\admin\resources\views\signup\create.blade.php ENDPATH**/ ?>