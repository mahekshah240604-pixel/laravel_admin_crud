				...
				<div class="forms">
					...
					<div class=" form-grids row form-grids-right">
						<div class="widget-shadow " data-example-id="basic-forms"> 
							...
							<div class="form-body">
								<form class="form-horizontal" method="POST" action="<?php echo e(route('product.update',$edit->product_id)); ?>" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>
                                                 ...
                                                 <input type="text" class="form-control" name="product_name" id="inputEmail3" value="<?php echo e($edit->product_name); ?>" placeholder="Enter Product Name"> </div> 
                                            </div> 
                                    <div class="form-group"> 
...
unset($__errorArgs, $__bag); ?>
                                                 ...
                                                 <input type="text" class="form-control" name="product_details" id="inputEmail3" value="<?php echo e($edit->product_details); ?>" placeholder="Enter Product details"> </div>
                                            </div> 
                                    <div class="form-group"> 
...
unset($__errorArgs, $__bag); ?>
                                                 ...
                                                 <input type="text" class="form-control" name="product_price" id="inputEmail3" value="<?php echo e($edit->product_price); ?>" placeholder="Enter Product details"></div>
                                            </div>
                                                 ...
                                                 <select name="category_id" class="form-control">
                                                    <option value="">Select Category</option>
                                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($category->category_id); ?>" <?php if($category->category_id==$edit->category_id): ?>selected <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                                                 ...
                                                 <input type="text" class="form-control" name="product_account" value="<?php echo e($edit->product_account); ?>" id="inputEmail3" placeholder="Enter Product account"> </div> 
                                            </div> 
...
unset($__errorArgs, $__bag); ?>
                                                 ...
                                                 <img src="/upload/<?php echo e($edit->product_photopath); ?>" width="100" alt=""><?php echo e($edit->product_photopath); ?><input type="file" class="form-control" name="product_photopath"  id="inputEmail3" placeholder="Enter Product image"> </div> 
                                            </div> 
...
</html><?php /**PATH C:\xampp\htdocs\laravel\admin\resources\views\product\edit.blade.php ENDPATH**/ ?>