							...
							<tbody>
								<?php $__currentLoopData = $mydata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userdata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($userdata->category_name); ?></td>
                                        <td>
                                            <form action="<?php echo e(route('category.destroy',$userdata->category_id)); ?>" method="post">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('DELETE'); ?>
						                            <input type="submit" value="delete">
                                            </form>
                                        </td>
                                        <td><a href="<?php echo e(route('category.edit',$userdata->category_id)); ?>">Edit</a></td>
                                    </tr>
...
</html><?php /**PATH C:\xampp\htdocs\laravel\admin\resources\views/category/index.blade.php ENDPATH**/ ?>