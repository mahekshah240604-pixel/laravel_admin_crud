				...
				<div class="forms">
					...
					<div class=" form-grids row form-grids-right">
						<div class="widget-shadow " data-example-id="basic-forms"> 
							...
							<div class="form-body">
								<form class="form-horizontal" method="POST" action="<?php echo e(route('category.update',$edit->category_id)); ?>" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                                 ...
                                                 <input type="text" class="form-control" value="<?php echo e($edit->category_name); ?>" name="category_name" id="inputEmail3" placeholder="Enter catagory name"> </div> 
                                            </div> 
...
</html><?php /**PATH C:\xampp\htdocs\laravel\admin\resources\views\category\edit.blade.php ENDPATH**/ ?>