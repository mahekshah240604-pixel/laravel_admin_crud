	...
	<?php echo $__env->make('theampart/header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
		...
		<div id="page-wrapper">
			<div class="main-page signup-page">
				...
				<form action="<?php echo e(route('login.update',$edit->login_id)); ?>" method="post" enctype="multipart/form-data">
					<?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\laravel\admin\resources\views\login\edit.blade.php ENDPATH**/ ?>