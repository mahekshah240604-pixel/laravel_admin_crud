						...
						<table class="table">
							...
							<tbody>
								<?php $__currentLoopData = $mydata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userdata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($userdata->signup_id); ?></td>
                                        <td><?php echo e($userdata->name); ?></td>
                                        <td><?php echo e($userdata->mobileno); ?></td>
                                        <td><?php echo e($userdata->email); ?></td>
                                        <td><?php echo e($userdata->password); ?></td>
                                        <td><?php echo e($userdata->gender); ?></td>
                                        <td>
                                            <form action="<?php echo e(route('signup.destroy',$userdata->signup_id)); ?>" method="post">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('DELETE'); ?>
                                                <input type="submit" value="delete">
                                            </form>
                                        </td>
                                        <td><a href="<?php echo e(route('signup.edit',$userdata->signup_id)); ?>">Edit</a></td>
                                    </tr>
...
</html><?php /**PATH C:\xampp\htdocs\laravel\admin\resources\views\signup\index.blade.php ENDPATH**/ ?>