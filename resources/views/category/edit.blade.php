				...
				<div class="forms">
					...
					<div class=" form-grids row form-grids-right">
						<div class="widget-shadow " data-example-id="basic-forms"> 
							...
							<div class="form-body">
								<form class="form-horizontal" method="POST" action="{{route('category.update',$edit->category_id)}}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PATCH')
                                        ...
                                        <label for="inputEmail3" class="col-sm-2 control-label">Category Name:</label> 
                                            <div class="col-sm-9">
                                                ...
                                                @enderror
                                                 ...
                                                 <input type="text" class="form-control" value="{{$edit->category_name}}" name="category_name" id="inputEmail3" placeholder="Enter catagory name"> </div> 
                                            </div> 
