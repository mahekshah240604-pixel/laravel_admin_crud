	...
	@include('theampart/header')
		...
		<div id="page-wrapper">
			<div class="main-page signup-page">
				...
				<form action="{{route('signup.update',$edit->signup_id)}}" method="post" enctype="multipart/form-data">
					@csrf
                    @method('PATCH')
					<div class="sign-u">
								@error('name')
								...
								@enderror
								<input type="text" name="name" value="{{$edit->name}}" placeholder="First Name">
								<br>
					...
					<div class="sign-u">
								@error('mobileno')
									<strong style="color: red">{{$message}}</strong>
								@enderror
								<input type="text"  name="mobileno" value="{{$edit->mobileno}}" placeholder="Mobile">
								<br>
						<div class="clearfix"> </div>
					</div>
					<div class="sign-u">
					...
					<div class="sign-u">
								@error('gender')
									<strong style="color: red">{{$message}}</strong>
								@enderror
								<input type="text" placeholder="Gender" value="{{$edit->gender}}" name="gender">
								<br>
						<div class="clearfix"> </div>
					</div>
						<div class="clearfix"> </div>
