                                        ...
                                        <label for="inputEmail3" class="col-sm-2 control-label">Product Name:</label> 
                                            <div class="col-sm-9">
                                                ...
                                                @enderror
                                                 ...
                                                 <input type="text" class="form-control" name="product_name" id="inputEmail3" value="{{old('product_name')}}" placeholder="Enter Product Name"> </div> 
                                            </div> 
                                    <div class="form-group"> 
                                        <label for="inputEmail3" class="col-sm-2 control-label">Product Details:</label> 
                                            <div class="col-sm-9">
                                                ...
                                                @enderror
                                                 ...
                                                 <input type="text" class="form-control" name="product_details" id="inputEmail3" value="{{old('product_details')}}" placeholder="Enter Product details"> </div>
                                            </div> 
                                    <div class="form-group"> 
                                        <label for="inputEmail3" class="col-sm-2 control-label">Product Price:</label> 
                                            <div class="col-sm-9">
                                                ...
                                                @enderror
                                                 ...
                                                 <input type="text" class="form-control" name="product_price" id="inputEmail3" value="{{old('product_price')}}" placeholder="Enter Product details"></div>
                                            </div>
                                        ...
                                        <label for="inputEmail3" class="col-sm-2 control-label">Product Account:</label> 
                                            <div class="col-sm-9">
                                                ...
                                                @enderror
                                                 ...
                                                 <input type="text" class="form-control" name="product_account" value="{{old('product_account')}}" id="inputEmail3" placeholder="Enter Product account"> </div> 
                                            </div> 
                                        ...
                                        <label for="inputEmail3" class="col-sm-2 control-label">Product image:</label> 
                                            <div class="col-sm-9">
                                                ...
                                                @enderror
                                                 ...
                                                 <input type="file" class="form-control" name="product_photopath" value="{{old('product_photopath')}}" id="inputEmail3" placeholder="Enter Product image"> </div> 
                                            </div> 
                                            {{-- <br> --}}
